...
> **基于2021/1/14 [Twikoo](https://twikoo.js.org/) 更新1.1.0-beta，所有表情都将以缩写形式（如:[ text ]:）输出。1/14之前本仓库有部分表情text缺失及重复, 导致无法正常使用表情**  
> **1/14后的所有表情json列表已全部更新，已适配Twikoo@1.1.0-beta及此后的版本**  
> **此前版本所造成的不便作者深感抱歉**
